...
public class BoardController {
    ...
    public ResponseEntity<? extends Object> createRecipe(@RequestPart @ApiParam(value="게시글 정보", required = true) RecipeCreateReq recipeCreateReq, @RequestPart @ApiParam(value="사진", required = false) List<MultipartFile> file) {
        try {
            ...
            boardStepsService.save(recipeCreateReq.getRecipe_steps(), Board, ImgNameList);  // 레시피 단계 글이랑 사진 DB에 저장
